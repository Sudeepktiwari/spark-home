...
const ConversationAnalysis = () => {
  return (
    <div className="lg:flex lg:pt-24 gap-16 ">
      <div
        className="relative lg:w-[50vw] w-[320px] overflow-hidden lg:mt-4 
      ...
      >
        <Lottie
          ...
          className="lg:w-[42vw] lg:h-[60vh] h-[220px] w-[320px] object-cover translate-y-[-1%] lg:shadow-lg"
        />
      </div>
      {/* <Skeleton className="lg:h-[80vh] lg:w-[50vw] w-[90vw] h-[30vh] md:h-[90vh] my-10 lg:my-0 " /> */}
      <div className="space-y-16 lg:w-[40vw] mt-10 lg:mt-2">
